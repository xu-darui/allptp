...
class Image
{
     ...
     * @return $this
     */
    public function crop($w, $h, $x = 0, $y = 0, $width = null, $height = null,$is_alpha=false)
    {
        //设置保存尺寸
        empty($width) && $width   = $w;
     ...
     * @return $this
     */
    public function thumb($width, $height, $type = self::THUMB_SCALING,$is_alpha=false)
    {
        //原图宽度和高度
        $w = $this->info['width'];
        $h = $this->info['height'];
        ...
        /* 裁剪图像 */
        return $this->crop($w, $h, $x, $y, $width, $height,$is_alpha);
    }
